...
groupfile1 = open('group1.txt', 'w')
groupfile2 = open('group2.txt', 'w')
#roupfile3 = open('group3.txt', 'w')
#groupfile4 = open('group4.txt', 'w')

#for j in range(numGroups):
#    for i in range(numNeurons):
#        if x[j*numGroups + i]:
#            groupfile1.write(str(i) + "\n")
...
for i in range(1000, 2000):
    if x[i]:
         groupfile2.write(str(i-1000) + "\n")

#for i in range(4000, 6000):
#    if x[i]:
#         groupfile3.write(str(i-4000) + "\n")

#for i in range(6000, 8000):
    #if x[i]:
         #groupfile4.write(str(i-6000) + "\n")
